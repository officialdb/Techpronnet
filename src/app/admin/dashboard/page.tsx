...
export default function AdminDashboardPage() {
  ...
  const recentQuotes = [
    { ref: 'TPN-20260806-9281', name: 'Horizon Corp Ltd', domain: 'Solar & Inverters', budget: '$15,000+', status: 'PENDING' },
    { ref: 'TPN-20260806-4410', name: 'Dr. Emmanuel Adebayo', domain: 'Security CCTV', budget: '$5,000 - $15,000', status: 'REVIEWED' },
    { ref: 'TPN-20260805-1192', name: 'Prime Health Clinic', domain: 'Software & SaaS', budget: '$15,000+', status: 'ESTIMATE_SENT' }
  ];
